...
export const ClearInputIcon: FC<IconProps> = ({ className = 'fill-black' }) => {
	return <svg xmlns="http://www.w3.org/2000/svg" fill="none" strokeWidth="0" viewBox="0 0 512 512" height="18px" width="18px" className={ className }>
		<path
